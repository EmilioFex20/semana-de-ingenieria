...
export default function Home() {
  return (
    <>
      {/*--- Hero ---*/}
      <section className="flex justify-center font-sans bg-brand lg:bg-white text-black">
      ...
      <section id="sobre" className="bg-white pt-16 pb-8">
        ...
        <Reveal className="w-5/6 lg:w-4/6 mx-auto mt-20 md:mt-28" delay={100}>
          <h2 className="text-3xl md:text-5xl lg:w-7/12 font-bold text-center mx-auto mb-6 text-balance leading-tight">
